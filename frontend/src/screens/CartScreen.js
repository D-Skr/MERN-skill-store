            ...
            <Col md={4}>
                <Card>
                    <ListGroup variant='primary'>
                        <ListGroup.Item>
                            <h2>Subtotal seats: {cartItems.reduce((acc, item) => acc + item.qty, 0)}</h2>
                            ${cartItems.reduce((acc, item) => acc + item.qty * item.price, 0).toFixed(2)}
                        </ListGroup.Item>
                        <ListGroup.Item>
                            <Button type='button' className='btn-block' disables={cartItems.length === 0} onClick={checkoutHandler}>
                                Proceed To Checkout
                            </Button>
                        </ListGroup.Item>
                    </ListGroup>
